...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { name: @type.name, recommendation_id: @type.recommendation_id } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { name: @type.name, recommendation_id: @type.recommendation_id } }
